...
Mute Message -> 吹き出しにしない言葉を設定します。改行して区切ってください。デフォルトのチャット蘭には表示されます。
...
Gui Texture Size -> 表示するテクスチャ（hukidashi_gui.png）の実際の表示部分のサイズを入力してください。
...
私のModでも連携しているので、参考にしてください。https://github.com/anaso/ReadSign/blob/master/src/main/java/anaso/ReadSign/ReadSignKey.java
リポジトリ https://github.com/anaso/ReadSign/
